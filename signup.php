                        ...
                        <div class="signup-form-container">
                            <div class="signup-form">
                                <table class="signup-account-table">
                                    ...
                                    <tr>
                                        <td align="middle">First name * <br><input type="text" class="form-input"
                                                name="fname" autocomplete="off" /></td>
                                    </tr>
                                    <tr>
                                        <td align="middle">Last name * <br><input type="text" class="form-input"
                                                name="lname" autocomplete="off" /></td>
                                    </tr>
                                    <tr>
                                        <td align="middle">Login name *<br><input dir="ltr" style="text-align:center;"
                                                type="text" class="form-input" name="loginname" autocomplete="off" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="middle">Password *<br><input type="password" class="form-input"
                                                name="password" autocomplete="off" /></td>
                                    </tr>
                                    <tr>
                                        <td align="middle">Re-password *<br><input type="password" class="form-input"
                                                name="repassword" autocomplete="off" /></td>
                                    </tr>
                                    <tr>
                                        <td align="middle">
                                    ...
                                    <tr>
                                        <td>
                                            <br>
                                            <div class="back">
                                                <a href="?page_is=login" class="back-to-login">&lArr; Back to Login</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
